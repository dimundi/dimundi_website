...
scp -i "%SSH_KEY%" compose.yml mailserver.env roundcube.php common.sh build.sh accounts.sh setup-tls.sh nginx-http.conf nginx-https.conf dkim.sh dkim-signing.conf "%TARGET%:%REMOTE_DIR%/"
if errorlevel 1 goto error
